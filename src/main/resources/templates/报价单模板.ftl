...
<Workbook
    ...
    <Styles>
        ...
        <Style ss:ID="s54">
            ...
            <Borders>
             <Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1"/>
              ...
              <Font ss:FontName="Arial" x:CharSet="0" ss:Size="10"/>
            <Interior/>
        </Style>
        <Style ss:ID="s55">
            <Alignment ss:Vertical="Bottom"/>
        ...
        <Style ss:ID="s59">
            <Alignment ss:Horizontal="Center"/>
            <Borders/>
            <Font ss:FontName="宋体" x:CharSet="134" ss:Size="16" ss:Color="#FF0000" ss:Bold="1"/>
            <Interior/>
        </Style>
        <Style ss:ID="s60">
            <Alignment ss:Horizontal="Center"/>
    ...
    <Worksheet ss:Name="报价单">
        <Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="7" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="33">
            <Column ss:Index="1" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="112.5"/>
            <Column ss:Index="2" ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="142.5"/>
            <Column ss:StyleID="s49" ss:AutoFitWidth="0" ss:Width="112.5" ss:Span="6"/>
            ...
            <Row>
                <Cell ss:StyleID="s61" ss:MergeAcross="9">
                    <Data ss:Type="String">报价单位：[报价单位]</Data>
                </Cell>
            </Row>
            <Row>
                <Cell ss:StyleID="s52">
        ...
        <#list orderDetails as orderDetail>
            <Row>
                ...
                <Cell ss:StyleID="s53">
                    <Data ss:Type="String">${orderDetail.name!}</Data>
                </Cell>
                <Cell ss:StyleID="s53">
                    <Data ss:Type="String">${orderDetail.spec!}</Data>
                </Cell>
                <Cell ss:StyleID="s53">
                    <Data ss:Type="String">${orderDetail.brands!}</Data>
                </Cell>
                <Cell ss:StyleID="s53">
            ...
            <Row>
                <Cell ss:StyleID="s62" ss:MergeAcross="6">
                    <Data ss:Type="String">附件：[文件名.后缀]  [文件名.后缀]  [文件名.后缀] [文件名.后缀]</Data>
                </Cell>
                <Cell ss:StyleID="s57"/>
                <Cell ss:StyleID="s57"/>
                <Cell ss:StyleID="s57"/>
            ...
            <Row>
                <Cell ss:StyleID="s63" ss:MergeAcross="6">
                    <Data ss:Type="String">报价说明：[备注内容]</Data>
                </Cell>
                <Cell ss:StyleID="s57"/>
                <Cell ss:StyleID="s57"/>
                <Cell ss:StyleID="s57"/>
        ...
        <WorksheetOptions
            ...
            <TabColorIndex>50</TabColorIndex>
