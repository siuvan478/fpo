...
<Workbook
    ...
    <DocumentProperties
        ...
        <Created>2018-03-20T13:26:31Z</Created>
        <LastSaved>2018-03-20T13:47:49Z</LastSaved>
    </DocumentProperties>
    ...
    <Worksheet ss:Name="报价汇总">
        <Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="10" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="43">
            ...
            <Column ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="105" ss:Span="253"/>
            <Row>
                <Cell ss:StyleID="s58" ss:MergeAcross="6">
                    <Data ss:Type="String">报价汇总</Data>
                </Cell>
            </Row>
            <Row>
...
<#list reportInfo.summaryList as report>
            ...
            <Row ss:Height="78">
                <Cell ss:StyleID="s60" ss:MergeAcross="6">
                    <ss:Data ss:Type="String"
                             xmlns="http://www.w3.org/TR/REC-html40">
                        <Font html:Color="#FF0000">＊最低组合价：</Font>将每家供应商最低单项报价相加，组合出的最低采购总价。&#10;              适用于采购物品超过5种以上，供应商报价达到6家的应用场景，最低组合价可帮助评估供应商成本价空间，&#10;              一般最低组合价的1.1-1.3倍之间，为合理的采购价区间。（仅供参考，请以项目实际情况为准）
                    </ss:Data>
                </Cell>
            </Row>
        </Table>
        <WorksheetOptions
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R4C9</RangeSelection>
                </Pane>
            </Panes>
