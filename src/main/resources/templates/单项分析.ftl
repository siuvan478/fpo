...
<Workbook
    ...
    <DocumentProperties
        ...
        <Created>2018-03-21T01:57:19Z</Created>
        <LastSaved>2018-03-21T02:04:01Z</LastSaved>
    </DocumentProperties>
    <CustomDocumentProperties
            xmlns="urn:schemas-microsoft-com:office:office">
        <KSOProductBuildVer dt:dt="string">2052-10.1.0.7223</KSOProductBuildVer>
    </CustomDocumentProperties>
    <ExcelWorkbook
    ...
    <Styles>
        ...
        <Style ss:ID="s59">
            ...
            <Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1"/>
              ...
              <Font ss:FontName="宋体" x:CharSet="134" ss:Size="14" ss:Color="#0D0D0D" ss:Bold="1"/>
            <Interior ss:Color="#BFBFBF" ss:Pattern="Solid"/>
        </Style>
        <Style ss:ID="s60">
            <Alignment ss:Horizontal="CenterAcrossSelection"/>
    ...
    <Worksheet ss:Name="单项分析">
        <Table ss:ExpandedColumnCount="256" ss:ExpandedRowCount="12" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="33">
            <Column ss:Index="1" ss:StyleID="Default" ss:AutoFitWidth="0" ss:Width="57"/>
            ...
            <Row>
                <Cell ss:StyleID="s68" ss:MergeDown="1">
                    <Data ss:Type="String">编号</Data>
                </Cell>
                <Cell ss:StyleID="s69" ss:MergeDown="1">
                    <Data ss:Type="String">产品名称</Data>
                </Cell>
                <Cell ss:StyleID="s70" ss:MergeDown="1">
                    <Data ss:Type="String">数量</Data>
                </Cell>
                <Cell ss:StyleID="s71" ss:MergeDown="1">
                    <Data ss:Type="String">单位</Data>
                </Cell>
<#list reportInfo.quoteDetails as quoteDetail><#--遍历公司名称-->
...
<#list reportInfo.orderDetails as orderDetail><#--遍历采购明细-->
            <Row>
                <Cell ss:StyleID="s56">
    ...
    <#list reportInfo.quoteDetails as quoteDetail> <#--遍历 报价明细--->
        <#list quoteDetail.details as d>
            <#if d.orderDetailId == orderDetail.id>
                <Cell ss:StyleID="s56">
                    <Data ss:Type="Number">${d.unitPrice}</Data>
                </Cell>
                <Cell ss:StyleID="s56">
                    <Data ss:Type="Number">${d.supplyQuantity}</Data>
                </Cell>
                <Cell ss:StyleID="s56">
                    <Data ss:Type="Number">${d.unitPrice * d.supplyQuantity}</Data>
                </Cell>
                <#break>
            </#if>
        </#list>
        ...
        <WorksheetOptions
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R16C10</RangeSelection>
                </Pane>
            </Panes>
