...
<Workbook
    ...
    <Worksheet ss:Name="采购清单">
        <Table ss:ExpandedColumnCount="253" ss:ExpandedRowCount="10" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="54" ss:DefaultRowHeight="31">
            ...
            <Row>
                <Cell ss:StyleID="s54">
                    <Data ss:Type="String">重要说明：请添加采购产品，勿修改首行标题信息，否则将引起数据导入出错</Data>
                </Cell>
                <Cell ss:StyleID="s55"/>
                <Cell ss:StyleID="s55"/>
                <Cell ss:StyleID="s55"/>
        ...
        <WorksheetOptions
            ...
            <Panes>
                <Pane>
                    ...
                    <RangeSelection>R4C10</RangeSelection>
                </Pane>
            </Panes>
